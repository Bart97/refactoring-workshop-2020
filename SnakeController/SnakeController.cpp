...
void Controller::timerUpdate(TimeoutInd const& timerEvent)
{
...
void Controller::changeDirection(DirectionInd const& directionInd)
{
...
void Controller::eatFood(FoodInd const& receivedFood)
{
...
void Controller::spawnFood(FoodResp const& requestedFood)
{
    bool requestedFoodCollidedWithSnake = false;
    for (auto const& segment : m_segments) {
